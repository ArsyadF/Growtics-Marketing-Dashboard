  ...
  >
    <div class="glass-card bg-white/95 dark:bg-slate-900/95 w-full max-w-md p-6 md:p-8 rounded-3xl shadow-2xl border border-white/60 dark:border-blue-900/40 space-y-6 relative">
      ...
      <div class="text-center space-y-2">
        <div class="inline-flex p-3 bg-theme-gradient text-white rounded-2xl shadow-lg text-2xl mb-2">
      ...
      <form @submit.prevent="handleLogin" class="space-y-4">
        ...
        <button 
          ...
          class="w-full bg-theme-gradient hover:from-[#149b73] hover:to-[#149b73] text-white font-bold py-3 rounded-xl text-xs transition-all shadow-md mt-2 disabled:opacity-50 cursor-pointer flex items-center justify-center"
        >
