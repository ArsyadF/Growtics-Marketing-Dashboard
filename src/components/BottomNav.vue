    ...
    <nav class="pointer-events-auto relative z-30 w-full max-w-md bg-white/90 dark:bg-[#14141434] backdrop-blur-md border border-white/20 dark:border-slate-800/80 rounded-3xl shadow-2xl grid grid-cols-5 items-center h-16 px-3">
      ...
      <div class="relative flex justify-center items-center">
        <button 
          ...
          class="absolute -top-10 w-14 h-14 bg-theme-gradient text-white rounded-full shadow-xl shadow-[#6060604f] flex items-center justify-center text-lg transition-all duration-300 active:scale-90 cursor-pointer border-4 border-slate-100 dark:border-[#020617c7]"
