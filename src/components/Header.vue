...
<template>
  <header class="transparent-header sticky top-0 z-10 pt-[max(1.5rem,env(safe-area-inset-top))] md:pt-4 px-4 md:px-6 pb-3 md:pb-4 flex flex-col md:flex-row gap-3 md:gap-0 justify-between md:items-center">
